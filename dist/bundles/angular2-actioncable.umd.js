(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@rails/actioncable')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@rails/actioncable'], factory) :
	(factory((global['angular2-actioncable'] = {}),global.ng.core,global['@rails/actioncable']));
}(this, (function (exports,core,ActionCableNs) { 'use strict';
...
var Cable = /** @class */ (function () {
    ...
    function Cable(url, params) {
        ...
        this.url = url;
        this.params = params;
        this.disconnectedSource = new Subject();
    ...
    Cable.prototype.channel = function (name, params) {
        ...
        var /** @type {?} */ channel = new Channel(this, name, params);
...
var Channel = /** @class */ (function () {
    ...
    function Channel(cable, name, params) {
        ...
        this.connectedSource = new Subject();
        this.disconnectedSource = new Subject();
        this.rejectedSource = new Subject();
